...
document.write('<p>Output scritto da Js</p>'); //2)viene letto x ultimo da js non è controllabile se non con css
document.write('<p>Pantera-scritto-da-Js</p>') //3)viene letto x ultimo da js non è controllabile se non con css
